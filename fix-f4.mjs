...
// === 1) Rewrite LifecycleChanger with role check + preflight ===
const changer = `"use client";
...
writeFileSync("components/enforcement/LifecycleChanger.tsx", changer, "utf8");
console.log("1) LifecycleChanger.tsx rewritten with role check + preflight");

// === 2) Patch core page: add LifecycleStepper ===
let page = readFileSync("app/dashboard/core/spv/[id]/page.tsx", "utf8");

// Add import
if (!page.includes("LifecycleStepper")) {
  page = page.replace(
    'import { LifecycleChanger }',
    'import { LifecycleStepper } from "@/components/LifecycleStepper";\nimport { LifecycleChanger }'
  );

  // Add stepper above the lifecycle section
  page = page.replace(
  ...
  writeFileSync("app/dashboard/core/spv/[id]/page.tsx", page, "utf8");
  console.log("2) Core page patched with LifecycleStepper");
} else {
  console.log("2) SKIP: LifecycleStepper already imported");
}
