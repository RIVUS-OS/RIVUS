...
export default function Page() {
  ...
  return <FinancePage
    ...
    subtitle="Projekcija novcanog toka — 30/90/365 dana"
    tabs={tabs}
    summary={[
      { label: "Trenutno stanje", value: "18.450 EUR", color: "text-green-600" },
      { label: "Ocekivani prihodi (30d)", value: "8.200 EUR", color: "text-green-600" },
      { label: "Ocekivani rashodi (30d)", value: "5.100 EUR", color: "text-red-600" },
      { label: "Projekcija (30d)", value: "21.550 EUR", color: "text-green-700" },
    ]}
    columns={[
      { key: "mjesec", label: "Mjesec" },
      { key: "ocPrihodi", label: "Oc. prihodi (EUR)", align: "right" },
      { key: "ocRashodi", label: "Oc. rashodi (EUR)", align: "right" },
      { key: "neto", label: "Neto (EUR)", align: "right" },
      { key: "kumulativ", label: "Kumulativ (EUR)", align: "right" },
    ]}
    data={[
      { mjesec: "Ozujak 2026.", ocPrihodi: "8.200,00", ocRashodi: "5.100,00", neto: "3.100,00", kumulativ: "21.550,00" },
