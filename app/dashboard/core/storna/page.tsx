...
export default function Page() {
  return <FinancePage
    ...
    subtitle="Stornirani racuni, knjizna odobrenja, povrati"
    summary={[
    ...
    columns={[
      ...
      { key: "originalRacun", label: "Original racun" },
      { key: "datum", label: "Datum" },
      { key: "razlog", label: "Razlog" },
      { key: "iznos", label: "Iznos (EUR)", align: "right" },
    ]}
    data={[
      { broj: "ST-001", originalRacun: "IR-2025-032", datum: "10.01.2026.", razlog: "Dupli racun", iznos: "600,00" },
