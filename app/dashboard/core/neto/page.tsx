...
export default function Page() {
  const tabs = [
    { label: "Mjesecno", href: "/dashboard/core/neto/mjesecno" },
    { label: "Kvartalno", href: "/dashboard/core/neto/kvartalno" },
    { label: "Godisnje", href: "/dashboard/core/neto/godisnje" },
  ...
  return <FinancePage
    ...
    summary={[
      ...
      { label: "Neto marza", value: "36.7%", color: "text-green-600" },
    ]}
    columns={[
      ...
      { key: "marza", label: "Marza (%)", align: "right" },
    ]}
    data={[
      { mjesec: "Veljaca 2026.", prihodi: "8.400,00", rashodi: "4.200,00", neto: "4.200,00", marza: "50.0%" },
      { mjesec: "Sijecanj 2026.", prihodi: "7.100,00", rashodi: "5.100,00", neto: "2.000,00", marza: "28.2%" },
