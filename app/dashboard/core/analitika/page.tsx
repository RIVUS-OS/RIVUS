...
export default function Page() {
  return <FinancePage
    title="Analiticke kartice"
    subtitle="Kartice po klijentu, dobavljacu, kontu"
    columns={[
      { key: "tip", label: "Tip" },
    ...
    data={[
      ...
      { tip: "Dobavljac", naziv: "Odvjetnik d.o.o.", duguje: "4.500,00", potrazuje: "5.250,00", saldo: "-750,00" },
      { tip: "Dobavljac", naziv: "Vercel Inc.", duguje: "120,00", potrazuje: "120,00", saldo: "0,00" },
    ]}
  />;
}