...
export default function CoreVertikaleBillingPage() {
  ...
  return (
    <div className="space-y-6">
      <div><h1 className="text-[22px] font-bold text-black">Vertikale naplata</h1><p className="text-[13px] text-black/50 mt-0.5">{verticals.length} vertikala, {formatEur(total)} provizija</p></div>
