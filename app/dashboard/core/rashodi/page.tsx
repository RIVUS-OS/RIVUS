...
export default function Page() {
  const tabs = [
    ...
    { label: "Plaće", href: "/dashboard/core/rashodi/place" },
    ...
    { label: "Mjesečno", href: "/dashboard/core/rashodi/mjesecno" },
  ...
  return <FinancePage
    ...
    summary={[
      ...
      { label: "Prošli mjesec", value: "5.100 EUR" },
      { label: "Ušteda", value: "-17.6%", color: "text-green-600" },
    ]}
    columns={[
    ...
    data={[
      ...
      { datum: "15.02.2026.", kategorija: "Pravni", opis: "Odvjetnička usluga", dobavljac: "Odvjetnik d.o.o.", iznos: "750,00", spv: "SAN-01" },
      { datum: "10.02.2026.", kategorija: "IT", opis: "Supabase Pro", dobavljac: "Supabase Inc.", iznos: "25,00", spv: "CORE" },
      { datum: "05.02.2026.", kategorija: "Plaće", opis: "Honorar PM", dobavljac: "Jurke Maričić", iznos: "2.000,00", spv: "SAN-01" },
