...
export default function CoreSpvBillingPage() {
  ...
  return (
    <div className="space-y-6">
      <div><h1 className="text-[22px] font-bold text-black">SPV Billing</h1><p className="text-[13px] text-black/50 mt-0.5">Mjesecni prihod: {formatEur(totalMonthly)}</p></div>
