...
export default function BankProfilPage() {
  const { allowed, loading: permLoading } = usePermission("bank_read");
  useEffect(() => { if (!permLoading && allowed) logAudit({ action: "BANK_PROFIL_VIEW", entity_type: "page", details: {} }); }, [permLoading, allowed]);
  ...
  return (
    <div className="space-y-6">
      <div><h1 className="text-[22px] font-bold text-black">Profil - Banka</h1></div>
