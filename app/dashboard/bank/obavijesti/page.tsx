...
export default function BankObavijestPage() {
  ...
  useEffect(() => { if (!permLoading && allowed) logAudit({ action: "BANK_OBAVIJESTI_VIEW", entity_type: "page", details: {} }); }, [permLoading, allowed]);
