...
export default function BankSpvDokumentiPage() {
  ...
  useEffect(() => { if (!permLoading && allowed) logAudit({ action: "BANK_SPV_SPV_DOKUMENTI_VIEW", entity_type: "page", details: {} }); }, [permLoading, allowed]);
