...
export default function AccSpvTokPage() {
  ...
  useEffect(() => { if (!permLoading && allowed) logAudit({ action: "ACCOUNTING_SPV_SPV_TOK_VIEW", entity_type: "page", details: {} }); }, [permLoading, allowed]);
  ...
  return (
    <div className="space-y-6">
      <div><h1 className="text-[22px] font-bold text-black">{spv.id} - TOK</h1><p className="text-[13px] text-black/50 mt-0.5">{tok.length} zahtjeva</p></div>
