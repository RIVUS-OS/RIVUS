...
export default function VerticalObavijestPage() {
  ...
  useEffect(() => { if (!permLoading && allowed) logAudit({ action: "VERTICAL_OBAVIJESTI_VIEW", entity_type: "page", details: {} }); }, [permLoading, allowed]);
