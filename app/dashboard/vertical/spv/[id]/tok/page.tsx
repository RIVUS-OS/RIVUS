...
export default function VertSpvTokPage() {
  ...
  useEffect(() => { if (!permLoading && allowed) logAudit({ action: "VERTICAL_SPV_SPV_TOK_VIEW", entity_type: "page", details: {} }); }, [permLoading, allowed]);
