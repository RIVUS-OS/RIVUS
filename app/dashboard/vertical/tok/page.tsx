...
export default function VerticalTokPage() {
  ...
  useEffect(() => { if (!permLoading && allowed) logAudit({ action: "VERTICAL_TOK_VIEW", entity_type: "page", details: {} }); }, [permLoading, allowed]);
