...
export default function Page() {
  ...
  return (
    <div>
      <div className="mb-6"><h1 className="text-[28px] font-bold text-[#0B0B0C] tracking-tight">Primljeni racuni</h1><p className="text-[14px] text-[#6E6E73]">Racuni od dobavljaca</p></div>
