...
export default function Page() {
  ...
  return (
    <div>
      <div className="mb-6"><h1 className="text-[28px] font-bold text-[#0B0B0C] tracking-tight">Postavke</h1><p className="text-[14px] text-[#6E6E73]">RIVUS CORE d.o.o. — NKD 66.19.0 + 64.99.0</p></div>
