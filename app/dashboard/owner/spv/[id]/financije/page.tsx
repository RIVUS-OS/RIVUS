...
import { getSpvById, getIssuedBySpv, getReceivedBySpv, getTransactionsBySpv, formatEur } from "@/lib/mock-data";
...
export default function OwnerSpvFinancijePage() {
  ...
  const transactions = getTransactionsBySpv(id as string);
