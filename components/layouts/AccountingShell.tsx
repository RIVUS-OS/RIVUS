...
import { Home, Building2, ClipboardList, Bell, User, LogOut, ArrowLeft, Search } from "lucide-react";

const accountingNav = [
  { label: "Pregled",          href: "/dashboard/accounting" },
  { label: "Dodijeljeni SPV",  href: "/dashboard/accounting/projekti" },
  { label: "Zahtjevi",         href: "/dashboard/accounting/zahtjevi" },
  { label: "Profil",           href: "/dashboard/accounting/profil" },
];
          ...
          {isInsideSpv ? (
            <>
              <button onClick={() => router.push("/dashboard/accounting/projekti")}
                ...
                <ArrowLeft size={15} strokeWidth={2.5} /><span>Moji SPV-ovi</span>
              </button>
              {spvData && (
            ...
            <div className="space-y-0.5">
              {accountingNav.map((item) => {
                const exact = item.href === "/dashboard/accounting";
