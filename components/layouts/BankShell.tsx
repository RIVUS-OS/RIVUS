...
const bankNav = [
  { label: "Pregled",              href: "/dashboard/bank" },
  { label: "SPV za evaluaciju",    href: "/dashboard/bank/evaluacije" },
  { label: "Arhiva",               href: "/dashboard/bank/arhiva" },
  { label: "Profil",               href: "/dashboard/bank/profil" },
];
          ...
          {isInsideSpv ? (
            <>
              <button onClick={() => router.push("/dashboard/bank/evaluacije")}
                ...
                <ArrowLeft size={15} strokeWidth={2.5} /><span>Evaluacije</span>
              </button>
              {spvData && (
                <div className="px-3 py-3 rounded-xl bg-[#2563EB]/5 border border-[#2563EB]/10">
                  ...
                  <div className="mt-1.5 text-[10px] font-medium text-[#8E8E93] bg-[#F5F5F7] px-2 py-0.5 rounded-full inline-block">Samo čitanje</div>
                </div>
              )}
            </>
          ) : (
            <div className="space-y-0.5">
              {bankNav.map((item) => {
                const exact = item.href === "/dashboard/bank";
