    ...
    <div className="flex h-screen bg-[#F7F7F8]" style={{ fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", Inter, system-ui, sans-serif' }}>
      <aside className="w-[240px] border-r border-[#E8E8EC] bg-white flex flex-col">
        <div className="h-[56px] border-b border-[#E8E8EC] flex items-center px-5 gap-2.5">
          ...
          <span className="text-[9px] font-bold text-[#8E8E93] bg-[#F5F5F7] px-2 py-0.5 rounded ml-1">VERT.</span>
        </div>
        <nav className="flex-1 overflow-y-auto px-3 py-4">
          {isInsideSpv && (<button onClick={() => router.push("/dashboard/vertical")} className="w-full flex items-center gap-2 px-3 py-2 mb-3 rounded-lg text-[13px] font-semibold text-[#2563EB] hover:bg-[#2563EB]/5 transition-all"><ArrowLeft size={15} strokeWidth={2.5} /><span>Natrag</span></button>)}
        ...
        <div className="border-t border-[#E8E8EC] px-4 py-3">
          <div className="flex items-center gap-3 mb-3"><div className="h-8 w-8 rounded-full bg-[#2563EB] flex items-center justify-center text-white text-[13px] font-bold">V</div><div><div className="text-[13px] font-semibold text-[#0B0B0C]">Vertikala</div><div className="text-[11px] text-[#8E8E93]">Vertical</div></div></div>
