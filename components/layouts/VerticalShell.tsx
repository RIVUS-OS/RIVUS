...
import {
  Home, FolderOpen, CheckSquare, Bell, LogOut, ArrowLeft, Search,
  MessageCircle, BookOpen, Briefcase, ClipboardList,
} from "lucide-react";
...
const verticalNav: NavItem[] = [
  { label: "Pregled",              href: "/dashboard/vertical",           icon: Home },
  { label: "Dodijeljeni projekti", href: "/dashboard/vertical/projekti",  icon: Briefcase },
  { label: "Moji zadaci",          href: "/dashboard/vertical/zadaci",    icon: CheckSquare },
  { label: "Dokumenti",            href: "/dashboard/vertical/dokumenti", icon: FolderOpen },
];
...
export default function VerticalShell({ children }: { children: React.ReactNode }) {
  ...
  // SPV sidebar — Vertikala sees assigned tasks + docs
  ...
  function isActive(href: string) {
    if (href === spvBase || href === "/dashboard/vertical") return pathname === href;
